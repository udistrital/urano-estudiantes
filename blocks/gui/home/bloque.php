...
class Bloque implements \Bloque {
	...
	function __construct($esteBloque, $lenguaje = "") {
		...
		$rutaUrlFuncionarios = $this->miConfigurador->getVariableConfiguracion ( "host_funcionarios" ) . $this->miConfigurador->getVariableConfiguracion ( "site" );
		
		if (! isset ( $esteBloque ["grupo"] ) || $esteBloque ["grupo"] == "") {
			$ruta .= "/blocks/" . $esteBloque ["nombre"] . "/";
			$rutaURL .= "/blocks/" . $esteBloque ["nombre"] . "/";
			$rutaUrlFuncionarios .= "/blocks/" . $esteBloque ["nombre"] . "/";
		} else {
			$ruta .= "/blocks/" . $esteBloque ["grupo"] . "/" . $esteBloque ["nombre"] . "/";
			$rutaURL .= "/blocks/" . $esteBloque ["grupo"] . "/" . $esteBloque ["nombre"] . "/";
			$rutaUrlFuncionarios .= "/blocks/" . $esteBloque ["grupo"] . "/" . $esteBloque ["nombre"] . "/";
		}
		...
		$this->miConfigurador->setVariableConfiguracion ( "rutaUrlFuncionarios", $rutaUrlFuncionarios );
