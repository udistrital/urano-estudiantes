...
class Formulario {
	...
	function formulario() {
		...
		$esteRecursoOracle = $this->miConfigurador->fabricaConexiones->getRecursoDB ( $conexionOracle );
		
		$conexionFuncionarios = 'estructura_funcionarios';
		$esteRecursoFuncionarios = $this->miConfigurador->fabricaConexiones->getRecursoDB ( $conexionFuncionarios );
		...
		$rutaUrlFuncionarios = $this->miConfigurador->getVariableConfiguracion ( "rutaUrlFuncionarios" );
		...
		if ($datosPerfiles) {
			$atributos ['nombre_usuario'] = mb_strtoupper ($datosPerfiles [0] [2] );
		} else {
